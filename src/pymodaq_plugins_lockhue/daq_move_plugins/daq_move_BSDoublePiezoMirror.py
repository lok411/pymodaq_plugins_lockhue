from pymodaq.control_modules.move_utility_classes import DAQ_Move_base, main, DataActuatorType, DataActuator  # base class
...
from pymodaq_plugins_lockhue.hardware.beam_steering import BeamSteering, BeamSteeringActuators

from pymodaq_plugins_mockexamples import config


class DAQ_Move_BSDoublePiezoMirror(DAQ_Move_base):
    """
    """

    _controller_units = BeamSteeringActuators.units
    is_multiaxes = True
    stage_names = BeamSteeringActuators.axes
    _epsilon = 0.01
    ...
    def get_actuator_value(self):
        ...
        return DataActuator(self.axis_name, data=pos)
    ...
    def move_abs(self, position: DataActuator):
        ...
        pos = self.controller.move_at(position.value(), self.axis_name)
